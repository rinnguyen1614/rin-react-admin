...
import ResourceTreeInput from "../resources/ResourceTreeInput";
  ...
  return (
    ...
    >
      <FormTab label={"resources.menus.tabs.general"}>
        ...
        <TextInput source="title" fullWidth validate={minLength(6)} />
        <TextInput source="icon" fullWidth validate={minLength(6)} />
        <TextInput source="component" fullWidth validate={minLength(6)} />
        <TextInput source="description" fullWidth validate={minLength(6)} />
